...
const Quote = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-center items-start content-between p-16 space-x-4 lg:mx-36">
      <div className="flex flex-col sm:flex-row md:items-center">
        ...
        <h1 className="xs:text-4xl md:text-6xl md:pl-2 md:ml-4 text-white font-clash">
          <TextAnimation children={"“Where Your Goals Meet World-Class AI”"} useCursor={true} />
        </h1>
      </div>
